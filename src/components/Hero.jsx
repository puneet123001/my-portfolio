...
const Hero = () => {
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-tr from-[#0f0f0f] via-[#232946] to-[#1a1a1a] px-6 relative overflow-hidden">
      ...
      >
        <motion.h1
          className="text-4xl sm:text-5xl font-extrabold text-white tracking-wide drop-shadow-lg"
          variants={textVariants}
          initial="hidden"
          animate="visible"
          custom={1}
        >
          Hi, I'm <span className="text-indigo-400 bg-indigo-400/10 px-2 rounded-lg">Puneet Jain</span>
        </motion.h1>
        <motion.p
